...
- **v1.4.0 (2026-04-09)**：新增基于物理弹簧算法（指数衰减）的全局极致平滑滚动引擎；新增可选的最后修改时间自动补全功能；修复了字体下拉列表的滚动缺陷并支持搜索；支持单文件发布极简版。
- **v1.3.3 (2026-04-09)**：修复 GitHub API 更新检测因为未打通系统代理在部分网络下静默失败的问题；设置界面新增跳转 Github Star 快捷入口。
