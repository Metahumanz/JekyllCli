...
这是一份面向最终用户的桌面端使用说明，适用于当前仓库内的 `JekyllCli` Windows 版。文中的页面名称、按钮名称和操作流程，均以当前版本的实际界面为准。

![JekyllCli 仪表盘真实截图](./images/real/dashboard-real.png)
...
![JekyllCli 存量管理真实截图](./images/real/manage-posts-real.png)
...
![JekyllCli 撰写页面真实截图](./images/real/editor-real.png)
...
![JekyllCli 博客设置真实截图](./images/real/settings-real.png)
...
![JekyllCli 软件设置真实截图](./images/real/app-settings-real.png)
...
本文中的配图已经替换为当前版本程序实际生成的界面截图，截图使用的是仓库内样板博客与演示数据，主要用于帮助读者快速对应页面结构与按钮位置。
